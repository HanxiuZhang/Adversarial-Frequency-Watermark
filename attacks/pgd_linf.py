...
def pgdlinf_direct(img: Tensor, label: Tensor, wm: Tensor, model: nn.Module, alpha:float, beta: float,block_size: int=8, steps: int=10, eps: float=10/255) -> Tensor:
    r'''
...
def pgdlinf_wm_opti(img: Tensor, label: Tensor, wm: Tensor, model: nn.Module, 
